                ...
                for (File file: files) {
                    ...
                    for (KlineType klineType : klineTypes) {
                        String outputPath = outputDirectory + File.separator
                                + klineType.getOutputDirectory()
                                + File.separator + file.getName().split("\\.")[0] + ".xlsx";
...
//        KlineApplicationContext klineApplicationContext =
//            new KlineApplicationContext("src/main/resources/SZ300181.txt",
//                KlineType.DAY_LINE, "src/main/resources/SZ300181.xlsx");
//        KlineApplicationContext klineApplicationContext =
